			...
			<div class="section group">
					  ...
					  <div class="blog_posts">
						<div class="section group example">
							<div class="col blog_1_of_2">
				                <div class="blog_img">
										<a href="${createLink(controller: 'blog', action: 'index')}"><img src="images/about-img2.jpg" alt=""></a>
				                </div>
							</div>
				...
				<div class="blog_posts">
						<div class="section group example">			
							<div class="col blog_1_of_2">
				                <div class="blog_img">
				                	<a href="${createLink(controller: 'blog', action: 'index')}"><img src="images/about-img1.jpg" alt=""></a>
				                </div>
							</div>
								<div class="col blogdata_1_of_2">
								<div class="blog_heading">
				...
				<div class="blog_posts">
						<div class="section group example">		
							<div class="col blog_1_of_2">
				                <div class="blog_img">
				                	<a href="${createLink(controller: 'blog', action: 'index')}"><img src="images/about-img3.jpg" alt=""></a>
				                </div>
							</div>
								<div class="col blogdata_1_of_2">
								<div class="blog_heading">
